<?php
/**
 * File: strabo_db_neo4j.php
 * Description: StraboDbNeo4j is an abstraction library to make
 ...
 */
	...
	class StraboDbNeo4j
	{
		...
		*/
		...
		function StraboDbNeo4j($neousername='', $neopassword='', $neohost='', $neoport='', $neomode='')
		{
