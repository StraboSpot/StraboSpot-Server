<?php
/**
 * File: 19_Reading_worksheet_information_without_loading_entire_file.php
 * Description: Handles 19 Reading worksheet information without loading entire file operations
 *
