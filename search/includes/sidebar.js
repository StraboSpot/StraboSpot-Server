...
function updateSearchRow(rownum){
	...
	if(valueOfSelect == ""){
		...
		$( "#minYearSearch_" + rownum ).keyup($.debounce(350, function(e) {
			//console.log(e.srcElement.attributes.id.nodeValue);
			var thisElementName = e.srcElement.attributes.id.nodeValue;
			if($("#"+thisElementName).val().length == 4){
				var thisElementVal = parseInt($("#"+thisElementName).val());
...
function doNewSearchTest(){
	...
	//console.log($("#ownerSearch_0"));
	
	//var e = document.getElementById("ownerSearch_0");
	//var strUser = e.options[e.selectedIndex].value;
	//console.log(e);
	
	//console.log(ownerSearchVals);
	
	//console.log($("#ownerSearch_0").getSelectedItemData().id);
	
	//console.log($("#ownerSearch_0").getSelectedItemIndex());
	
	//console.log($("#ownerSearch_0").getSelectedItemData());
	
	//console.log($("#ownerSearch_0"));
	
	//console.log("Owner Search Vals:");
	//console.log(ownerSearchVals);

	//console.log("Sample ID Val: ");
	//console.log($("#sampleIDSearch_1").val());
...
function panToDataset(datasetId){  //pan to dataset and highlight
	...
	if(foundObject){
		...
		//console.log(savedCenterZoom.center);
