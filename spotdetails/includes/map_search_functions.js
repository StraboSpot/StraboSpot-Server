...
//add features from a single dataset
	...
	console.log('searchspots.json?env='+env+'&dsets='+id);
...
//get info for current spot and tab and update UI
	...
	let bkup0507getImageInfo = function(imageid){
	return new Promise(function(resolve, reject){
...
//var gotoDataset = function(datasetid){
	...
	*/
	...
	mapView.fit(newgeometry, {duration: 10});
}
