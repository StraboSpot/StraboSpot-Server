	...
	if($_POST['submit']=="Save"){
		...
		$db->query("
			update giga set
				...
				minerals_present='$minerals_present',
				polarization='$polarization',
				pixel_size_mm='$pixel_size_mm',
				width_of_field_mm='$width_of_field_mm',
				credit='$credit',
				p_gigapan_id='$p_gigapan_id',
				x_gigapan_id='$x_gigapan_id',
				longitude='$longitude',
				latitude='$latitude',
				keywords=$vectors,
		...
		//delete here
		$db->query("delete from giga where pkey=$pkey");
