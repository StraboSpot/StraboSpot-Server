...
$row = $db->get_row_prepared("SELECT * FROM micro_projectmetadata WHERE id = $1 AND (ispublic OR userpkey=$2)",
	array($id, $userpkey));
...
<div class="projectWrapper">
	...
	<div style="float:left; width: 300px; text-align:left; padding-left: 100px; vertical-align:baseline; font-size:1.2em; background-color:white;">
		...
		?>
		<br>
		<a href="/download_micro_pdf?project_id=<?php echo $id?>" target="_blank">
		...
		<?php
			if($userpkey != 999999){
		?>
		<a href="/share_micro_file?project_id=<?php echo $id?>" target="_blank">
