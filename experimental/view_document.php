 ...
 * Description: Displays information from straboexp table(s)
 *
...
$docUUID = isset($_GET['u']) ? preg_replace('/[^a-zA-Z0-9\-]/', '', $_GET['u']) : '';
if($docUUID == "") die("Document not found.");
$row = $db->get_row_prepared("SELECT * FROM straboexp.document WHERE uuid = $1 LIMIT 1", array($docUUID));
