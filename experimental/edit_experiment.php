...
<div class="topTitle">Edit Experiment</div>
...
<div id="sourceDataHeaderRow" style="margin-top: 5px; width: 720px !important; display:none;">
	<div class="formCell" style="width:660px;padding-left:0px !important;">
		...
		<div class="formRow">
			<div class="formCell w25">
				<div class="formPart">
					<label class="formLabel tooltipper" exp-code="headerSpecA">Specifier A<span class="reqStar">*</span></label>
					<div id="specAHolder">
...
<div id="bigWindow">
	...
	<div class="centerLeftRight" style="clear: both;">
		<div style="float:left; width:33%;"><button class="metadataButton" style="vertical-align:middle" onclick="exper_openChooseExperimentModal('all');"><span>Load All Data from Previous Experiment </span></button></div>
		<div style="float:left; width:33%;">&nbsp;</div>
		<div style="float:left; width:33%;"><button class="metadataButton" style="vertical-align:middle" onclick="exper_loadDataFromJSON('all');"><span>Load All Data from JSON File </span></button></div>
	</div>
	...
	<div style="text-align:center;">
		...
		<button class="submitButton" style="vertical-align:middle;margin-left:150px;" onclick="doSubmitEditExperiment()"><span>Save Changes </span></button>
	</div>
...
document.addEventListener("DOMContentLoaded", function(event){
	exper_fetchExperiment(<?php echo $experiment_pkey?>,"all");
});
</script>
