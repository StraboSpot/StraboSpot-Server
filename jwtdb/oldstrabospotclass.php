	...
	public function getMyProjects(){ //order by p.uploaddate desc
		...
		if($count > 0){
			...
			foreach($rows as $row){
				...
				/*
				[modified_timestamp] => 1687462422977
				[uploaddate] => 1687462474
...

	{
	  ...
	  "modified_timestamp": 1457377455
				...
				*/
				...
				$data['projects'][$x]['date']=$upload_date;
				$data['projects'][$x]['modified_timestamp']=substr($fd->modified_timestamp, 0, 10)."";
	...
	public function insertProject($injson,$thisid=null){
		...
		if($thisid != ""){
			...
			if($record){
				...
				/* switch to update always JMA 08/04/2021
