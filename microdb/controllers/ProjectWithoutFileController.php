<?php
/**
 * File: ProjectWithoutFileController.php
 * Description: ProjectWithoutFileController class
 *
...
class ProjectWithoutFileController extends MyController
{
	...
	public function postAction($request) {
		...
		$this->sm->logToFile($_POST, "POSTED to ProjectWithoutFileController");

		$data = $this->sm->insertProjectWithoutFile($_POST);
		//sleep(10);
