<?php
/**
 * File: devProjectPDFController.php
 * Description: devProjectPDFController class
 *
...
class devProjectPDFController extends MyController
{
	public function getAction($request) {
		...
		if(isset($request->url_elements[2])) {
			...
			if(isset($request->url_elements[3])) {
				...
				$data = $this->sm->devgetProjectPDF($project_id);
