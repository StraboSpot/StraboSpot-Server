<?php
/**
 * File: ProjectCountController.php
 * Description: ProjectCountController class
 *
...
class ProjectCountController extends MyController
{
	public function getAction($request) {
		...
		if(isset($request->url_elements[2])) {
			...
			if(isset($request->url_elements[3])) {
				...
				$projectcount = $this->sm->getProjectCount($project_id);
