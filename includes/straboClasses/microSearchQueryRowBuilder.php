<?php
/**
 * File: microSearchQueryRowBuilder.php
 * Description: microSearchQueryRowBuilder class
 *
...
class microSearchQueryRowBuilder {
		...
		foreach($json as $searchitem){
			...
			if($constraints[0]->constraintType == "keyword" ){
				if($constraints[0]->constraintValue != ""){
					...
					$thisitem .= "strabomicro.micro_projectmetadata.keywords @@ to_tsquery('$newkeywords')";
				}else{
					$thisitem .= "1 = 2";
				}
			}
