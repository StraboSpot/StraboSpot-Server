...
class straboOutputClass
{
	...
	public function oldxlsOut02032020(){
	...
	public function oldxlsOut11022020(){
...
//exit();
	...
	public function oldstereonetOut09222020(){
	...
	public function stereonetOutbkup09222020pm2(){
	...
	/*
		public function stereonetOutbkup09222020pm(){
	...
	*/
	...
	public function old06052020fieldbookOut(){
...
public function fieldbookOut(){
				...
				foreach($spotdates as $spotdate){
					...
					foreach($spots as $spot){
						...
						if($thisspotdate == $spotdate->showformat){
							...
							//$pdf->valueRow("Orientations","",15);
							//$pdf->valueTitle("Sed Lithologies","",20);
							//$pdf->valueRow("mykey","myvalue",25);
	...
	public function oldnewfieldbookOut(){
