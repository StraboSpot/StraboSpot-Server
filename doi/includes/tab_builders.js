...
/************ sed_interpretations Tab ****************************/
	...
	let content = currentSpot.properties.sed.strat_section;
			...
			//20240603 tabhtml += '<div onClick="window.open(\'https://strabospot.org/doi/strat_section?id='+currentSpot.properties.id+'&u='+projectuuid+'\');" class="map_icon"><img src="/search/includes/images/map.png" width="15" height="15"> View Strat Section</div>';

			tabhtml += '<div onClick="switchToStratSection(\''+currentSpot.properties.sed.strat_section.strat_section_id+'\');" class="map_icon"><img src="/search/includes/images/map.png" width="15" height="15"> View Strat Section</div>';

			tabhtml += '<div onClick="window.open(\'https://strabospot.org/doi/strat_section?id='+currentSpot.properties.id+'&u='+projectuuid+'\');" class="map_icon"><img src="/search/includes/images/download.png" width="15" height="15"> Download Strat Section</div>';

			//tabhtml += '<div onClick="window.open(\'https://strabospot.org/doi/strat_section?id='+currentSpot.properties.id+'&u='+projectuuid+'\');" class="map_icon"><img src="/search/includes/images/map.png" width="15" height="15"> View Strat Section</div>';
